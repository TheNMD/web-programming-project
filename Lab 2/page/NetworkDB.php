...
<html lang="en">
  ...
  <body>
    ...
    <!-- Content -->
    <div id="network" class="container-fluid pt-4 py-4">
      <div class="row pt-2 p-4 d-flex justify-content-center">
        <div class="col-sm pt-2 p-4 d-flex justify-content-center">
          <div class="card text-center">
            <img class="card-img-top" src="../image/SCA.png" alt="Card image cap">
            <div class="card-body">
              <h5 class="card-title">Simple chat app</h5>
              <a id="card_button" href="https://github.com/TheNMD/network-project" class="btn" role="button">Check it out!</a>
            </div>
          </div>
        </div>
        <div class="col-sm pt-2 p-4 d-flex justify-content-center">
          <div class="card text-center">
            <img class="card-img-top" src="../image/DB.jpg" alt="Card image cap">
            <div class="card-body">
              <h5 class="card-title">Python & MySQL</h5>
              <a id="card_button" href="https://github.com/TheNMD/database-project" class="btn" role="button">Check it out!</a>
            </div>
          </div>
        </div>
        <div class="col-sm pt-2 p-4 d-flex justify-content-center">
