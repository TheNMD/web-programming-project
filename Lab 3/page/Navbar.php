  ...
  <body> 
    ...
    <nav id="navbar" class="navbar navbar-expand-sm fixed-top">
      <div class="container-fluid">
        <a class="navbar-brand" href="#" style="color: #315336">Nguyen Manh Dan</a>
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li>
                  <form method="post" action="AIML.php">
                    <button id="innernavbtn" type="submit" class="btn">AI & ML</button>
                  </form>
                </li>
                <li>
                  <form method="post" action="NetworkDB.php">
                    <button id="innernavbtn" type="submit" class="btn">Network & DB</button>
                  </form>
                </li>
                <li>
                  <form method="post" action="Other.php">
                    <button id="innernavbtn" type="submit" class="btn">Other</button>
                  </form>
                </li>
              </ul>
            </li>
